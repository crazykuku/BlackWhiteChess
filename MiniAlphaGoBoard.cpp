...
MiniAlphaGoBoard::MiniAlphaGoBoard(QWidget *parent)
{
    first = NS_MAGBOARD::AI_FIRST;
        ...
        restart->setGeometry(400,520,90,50);
        restart->setStyleSheet("color:black;font : 25px;background:grey");
        QObject::connect(restart,&QPushButton::clicked,this,&MiniAlphaGoBoard::rest);
...
void MiniAlphaGoBoard::mousePressEvent(QMouseEvent *event)
{
    ...
    //get coordinate
    int32_t _x = event->x() - NS_MAGBOARD::BOARD_X;
    int32_t _y = event->y() - NS_MAGBOARD::BOARD_Y;
